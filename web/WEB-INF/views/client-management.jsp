...
<!--  PAPER WRAP -->
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="add-form">
                        <div class="form-group">
                            <label for="add-name" class="col-sm-2 control-label">客户姓名</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="add-id_type" class="col-sm-2 control-label">证件类型</label>
                            <div class="col-sm-10">
                                <select class="form-control" name="id_type" id="add-id_type">
                                    <option value="110001">身份证</option>
                                    <option value="110025">护照</option>
                                    <option value="110021">台湾通行证</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="add-id_code" class="col-sm-2 control-label">证件号码</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                              <label for="add-country_code" class="col-sm-2 control-label">所属国家</label>
                              <div class="col-sm-10">
                                  <select class="form-control" name="country_code.code" id="add-country_code">
                                  </select>
                              </div>
                          </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="edit-form">
                        <div class="form-group">
                            <label for="edit-name" class="col-sm-2 control-label">客户姓名</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name"
                                       id="edit-name">
                            </div>
                        ...
                        <div class="form-group">
                            <label for="edit-id_type" class="col-sm-2 control-label">证件类型</label>
                            <div class="col-sm-10">
                                <select class="form-control" name="id_type" id="edit-id_type">
                                    <option value="110001">身份证</option>
                                    <option value="110025">护照</option>
                                    <option value="110021">台湾通行证</option>
                                </select>
                        ...
                        <div class="form-group">
                            <label for="edit-id_code" class="col-sm-2 control-label">证件号码</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="id_code"
                                       id="edit-id_code">
                            </div>
                        ...
                        <div class="form-group">
                            <label for="edit-address" class="col-sm-2 control-label">联系地址</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="address"
                                       id="edit-address">
                            </div>
                        ...
                        <div class="form-group">
                            <label for="edit-country_code" class="col-sm-2 control-label">所属国家</label>
                            <div class="col-sm-10">
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <!-- BREADCRUMB -->
            <ul id="breadcrumb">
                <li><a href="#" title="Sample page 1">客户管理</a></li>
            </ul>
                        ...
                        <div class="nest" id="tabletreeClose">
                            ...
                            <div class="body-nest" id="tabletree">
                                ...
                                <form class="form-inline" id="search-form">
                                    ...
                                    <div class="form-group">
                                        <label for="id_code" class="sr-only"></label> <input
                                            type="text" class="form-control" id="id_code"
                                            name="id_code">
                                    </div>
                                    <div class="form-group">
                                        <label class="sr-only">cellphone</label>
                                        <p class="form-control-static">手机号码</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="cellphone" class="sr-only"></label><input
                                ...
                                <table id="example-advanced" class="client-table">
...
<script type="text/javascript">
    ...
    function build_table(list) {
        ...
        $.each(list, function (index, item) {
            ...
            var typeTd = $('<td></td>').append(item.id_type == '110001'?'身份证':(item.id_type == '110025'?'护照':'其他'));
            ...
            $('<tr></tr>').append(idTd).append(nameTd).append(typeTd).append(codeTd).append(phoneTd).append(addressTd).append(countryTd).append(btnTd)
                .appendTo('.client-table tbody');
        })
    }
        ...
        $.ajax({
            ...
            success:function (result) {
                $.each(result.info.countries,function (i,item) {
                    ...
                    $('#add-country_code').append('<option value="'+result.info.countries[i].code+'">'+result.info.countries[i].c_name+'</option>');
                })
            }
        })
    }
    ...
    $(document).on(
        ...
        function () {
            $.ajax({
                url: '${cp}/getClient/' + $(this).attr('edit-id'),
                method: 'get',
                success: function (result) {
                    var clientDate = result.info.client;
                    $('#edit-name').val(clientDate.name);
                    $('#edit-id_type').val(clientDate.id_type);
                    $('#edit-id_code').val(clientDate.id_code);
                    $('#edit-address').val(clientDate.address);
                    $('#edit-phone').val(clientDate.cellphone);
                    $('#edit-country_code').val(clientDate.country_code.id);
    ...
    $('#update-btn').click(function () {
        $.ajax({
            url: '${cp}/updateClient/' + $(this).attr('edit-id'),
            method: 'post',
    ...
    $(document).on('click', '.del-btn', function () {
        var clientName = $(this).parents('tr').find('td:eq(1)').text();
        var clientId = $(this).attr('del-id');
        if (confirm('确定要删除用户[' + clientName + ']吗?')) {
            $.ajax({
                url: '${cp}/delClient/' + clientId,
                method: 'delete',
                async: false,
                success: function (result) {
                    if (result.code == 200) {
