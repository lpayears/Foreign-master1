...
<div>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <!-- BREADCRUMB -->
            <ul id="breadcrumb">
                <li><a href="#" title="Sample page 1">账户报表</a></li>
            </ul>
                            ...
                            <div class="body-nest" id="tabletree">
                                ...
                                <form class="form-inline" id="search-form">
                                    ...
                                    <select class="select-width" name="type" id="select-type" >
                                        <option value=""></option>
                                        <option value="1001">新增</option>
                                        <option value="1002">久悬不动</option>
                                        <option value="1003">已销户</option>
                                    </select>
...
<script type="text/javascript">
    ...
    function build_table(list) {
        ...
        $.each(list, function (index, item) {
            ...
            $('<tr></tr>').append(idTd).append(accountTd).append(nameTd).append(typeTd).append(stTd).append(statusTd).append(branchTd).append(detailBtn)
    ...
    $('#export').click(function () {
        alert("是否导出？");
        window.open('${cp}/exportCompany' +'?'+ $('#search-form').serialize());
